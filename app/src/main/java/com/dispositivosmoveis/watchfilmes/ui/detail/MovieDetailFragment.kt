...
import com.dispositivosmoveis.watchfilmes.databinding.FragmentMovieDetailBinding
import com.dispositivosmoveis.watchfilmes.extensions.shareContentWithImage
...
class MovieDetailFragment : Fragment() {
    ...
    private fun shareMovie() {
        viewModel.movie.value.let {
            if (it != null) {
                val shareContent = "Confira agora esse filme no WatchFilmes.\n\n filmes.uniritter.edu.br/filme?id=" + it.id + "&de=Admin"
